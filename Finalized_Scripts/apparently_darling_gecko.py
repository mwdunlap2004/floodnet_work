#!/usr/bin/env python3
"""Delineate storms on a specific, high-reliability golden gage."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Delineate buffered/merged storms for a specific golden gage."
    )
    ...
    print(f"🚀 Starting Storm Delineation for Golden Gage: {args.target_gage}")
    ...
    COPY (
        WITH wet_records AS (
            ...
            WHERE "precip_incremental [inch]" >= {args.min_wet_threshold}
              AND deployment_id = '{args.target_gage}'
        ),
        ...
        all_records_in_storms AS (
            ...
            WHERE d.deployment_id = '{args.target_gage}'
        ),
